...
function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send(
        'service_t7cvpvk',  // Service ID
        'template_a3mitgu', // Template ID
        {
    ...
    >
      ...
      >
        ...
        <Reveal direction="up" delay={0.25}>
          ...
          >
            Whether you have a question, want to collaborate, or just want to say hello — I&apos;d love to hear from you. Drop me a message and I&apos;ll get back to you soon.
          </p>
        </Reveal>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <div style={{ marginBottom: "2.5rem", position: "relative" }}>
                  <label
                    ...
                    style={{
                      position: "absolute",
                      left: 0,
                      top: formData.name || focused.name ? "-20px" : "12px",
                      fontFamily: "Syne",
                      fontSize:
                        formData.name || focused.name ? "0.75rem" : "0.95rem",
                      fontWeight: 600,
                      color:
                        focused.name
                          ? "#c9a7ff"
                          : "rgba(201, 167, 255, 0.45)",
                ...
                <div style={{ marginBottom: "2.5rem", position: "relative" }}>
                  <label
                    ...
                    style={{
                      position: "absolute",
                      left: 0,
                      top: formData.email || focused.email ? "-20px" : "12px",
                      fontFamily: "Syne",
                      fontSize:
                ...
                {/* Contact Reason - Creative Chip Selector */}
                  ...
                  >
                    {CONTACT_REASONS.map((type) => (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          setFormData({ ...formData, reason: type })
                        }
                        style={{
                ...
                <div style={{ marginBottom: "2.5rem", position: "relative" }}>
                  <label
                    ...
                    style={{
                      ...
                      left: 0,
                      top:
                        formData.message || focused.message ? "-20px" : "12px",
                      fontFamily: "Syne",
                      fontSize:
                ...
                {/* Submit Button with Pulsing Aura */}
                ...
                {[...Array(12)].map((_, i) => (
                  <div
                    ...
                    style={{
                      ...
                      height: "8px",
                      borderRadius: "50%",
                      background: "rgba(201, 167, 255, 0.9)",
                      boxShadow: "0 0 10px rgba(108, 43, 217, 0.8)",
        ...
        <Reveal direction="up" delay={0.55}>
          ...
          >
            ...
            >
              <span>
                © 2026 Khaled Amr · Web Developer @ WaveDev. All rights reserved.
              </span>
